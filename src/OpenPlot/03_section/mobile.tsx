...
export default function Mobile() {
  ...
  const icons = {
    ...
    Users: (
      <Users size={20} strokeWidth={2.2} className="text-white relative z-10" />
    ),
  };
  return (
    <section
        ...
        >
          {data.cards.map((card, index) => (
            ...
            >
              ...
              <h3
                className="text-[18px] font-bold mb-3 relative z-10"
                style={{ color: NAVY }}
              >
                {card.title}
              </h3>
              ...
              <div
                className="flex items-center text-[13px] font-bold tracking-wide relative z-10"

...
export default function Desktop() {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-[10%] right-[15%] w-[700px] h-[700px] bg-gradient-radial from-[#C5D9FF]/40 to-transparent rounded-full blur-[140px] pointer-events-none z-0"></div>
            <div className="absolute bottom-[15%] left-[10%] w-[500px] h-[500px] bg-gradient-radial from-[#C99A2E]/[0.05] to-transparent rounded-full blur-[120px] pointer-events-none z-0"></div>
            <div className="absolute top-[60%] right-[5%] w-[300px] h-[300px] bg-gradient-radial from-[#818CF8]/[0.06] to-transparent rounded-full blur-[80px] pointer-events-none z-0"></div>
            ...
            <div className="max-w-[1320px] w-full px-8 lg:px-14 py-20 lg:py-28 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 xl:gap-20 items-center">
                    ...
                    >
                        ...
                        <motion.div variants={item} className="flex flex-wrap items-center gap-4 mb-10">
                            <button
                                className="group text-white text-[14px] font-semibold px-8 py-4 rounded-xl hover:shadow-[0_20px_40px_-10px_rgba(11,29,58,0.35)] active:scale-[0.97] transition-all duration-300 flex items-center gap-3 shadow-[0_8px_24px_-6px_rgba(11,29,58,0.25)] relative overflow-hidden"
                    ...
                    >
                        ...
                        <div className="absolute -top-4 -right-4 w-[calc(100%+8px)] h-[calc(100%+8px)] max-w-[520px] aspect-square rounded-3xl border-2 border-[#C99A2E]/15 pointer-events-none"></div>
                        <div className="absolute -bottom-3 -left-3 w-20 h-20 rounded-2xl bg-gradient-to-br from-[#C99A2E]/20 to-[#C99A2E]/5 blur-sm pointer-events-none"></div>

                        <div className="relative w-full aspect-square max-w-[500px] rounded-2xl overflow-hidden shadow-[0_30px_60px_-15px_rgba(11,29,58,0.3),0_0_0_1px_rgba(255,255,255,0.5)_inset] group">
                            <img
                                src={openplotHero}
                                alt="Open Plot Hero"
                            ...
                            <motion.div
                                ...
                                className="absolute bottom-5 left-5 right-5 bg-white/90 backdrop-blur-xl rounded-xl p-4 shadow-[0_8px_32px_-8px_rgba(11,29,58,0.2)] border border-white/60"
                            >
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#34D399] to-[#10B981] flex items-center justify-center shadow-md">
                        ...
                        <motion.div
                            ...
                            className="absolute -right-6 top-[20%] bg-white/90 backdrop-blur-xl rounded-xl p-3.5 shadow-[0_12px_40px_-10px_rgba(11,29,58,0.18)] border border-white/60 hidden xl:block"
                        >
                            <div className="flex items-center gap-2.5">
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center text-[14px] font-black text-white" style={{ background: `linear-gradient(135deg, ${GOLD}, ${GOLD_LIGHT})` }}>
                                    %
                                </div>
                                <div>

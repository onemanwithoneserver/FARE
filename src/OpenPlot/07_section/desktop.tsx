    ...
    >
      <div
        ...
        style={{
          ...
          maskImage:
            "linear-gradient(to right, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 25%, rgba(0,0,0,0) 75%, rgba(0,0,0,1) 100%)",
          WebkitMaskImage:
            "-webkit-linear-gradient(left, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 20%, rgba(0,0,0,0) 80%, rgba(0,0,0,1) 100%)",
        }}
      ></div>
      ...
      >
        ...
        >
          ...
          <motion.h2
            variants={itemVariant}
            className="text-[3.5rem] lg:text-[4rem] leading-[1.05] font-black tracking-[-0.02em] text-[#0B1D3A] mb-8 w-full relative z-10 max-w-[850px]"
          >
            {data.headline}
          </motion.h2>
          <motion.p
            variants={itemVariant}
            className="text-[18px] font-medium max-w-[700px] leading-[1.65] mb-14 text-[#475569] px-10 relative z-10"
          >
            {data.subtitle}
          </motion.p>
          <motion.div
            variants={itemVariant}
            className="flex items-center justify-center gap-6 px-10 relative z-10"
          >
            <motion.button
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.98 }}

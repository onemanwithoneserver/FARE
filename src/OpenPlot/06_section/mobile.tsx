...
export default function Mobile() {
    ...
    return (
        <section className="w-full py-10 bg-white relative font-['Outfit'] overflow-hidden">
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-[-100px] w-[300px] h-[300px] bg-gradient-radial from-[#F1F5FB] to-transparent rounded-full blur-[60px] pointer-events-none"></motion.div>
            ...
            <div className="w-full px-5 relative z-10">
                ...
                >
                    ...
                    <motion.div variants={item} className="bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded p-8 shadow-[0_15px_30px_-10px_rgba(11,29,58,0.2)] flex flex-col items-center text-center relative overflow-hidden">
                        <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-0 w-24 h-24 bg-[#C99A2E]/20 rounded-full blur-[30px] pointer-events-none"></motion.div>
                        ...
                        <button className="group w-full bg-white text-[#0B1D3A] px-6 py-4 rounded text-[14px] font-bold flex items-center justify-center gap-2 shadow-sm active:scale-[0.98] transition-all relative z-10">

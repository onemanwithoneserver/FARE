      ...
      <div className="w-full px-5 relative z-10">
        ...
        >
          <div className="flex flex-col">
            ...
            <motion.h2
              variants={item}
              className="text-[2rem] sm:text-[2.25rem] leading-[1.12] font-black tracking-[-0.02em] mb-6"
              style={{ color: NAVY }}
            >
              {headlineSentences.map((sentence, i) => (
                <React.Fragment key={i}>
                  {i === 0 ? (
                    ...
                    <span className="text-[#C99A2E] block mt-1">
                      {sentence}
                    </span>
                  )}
                </React.Fragment>
            ...
            <motion.div variants={item} className="mb-6">
              <p className="text-[16px] font-bold mb-4" style={{ color: NAVY }}>
                {data.desc1}
              </p>
          ...
          <motion.div
            variants={item}
            className="bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded p-8 shadow-[0_15px_30px_-10px_rgba(11,29,58,0.2)] flex flex-col items-center text-center relative overflow-hidden"
          >
            <motion.div
              animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}

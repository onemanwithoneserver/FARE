...
export default function Desktop() {
    ...
    return (
        <section className="w-full py-16 bg-white relative font-['Outfit'] overflow-hidden">
            ...
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute top-1/2 left-[-10%] w-[800px] h-[800px] bg-gradient-radial from-[#F1F5FB]/80 to-transparent rounded-full blur-[120px] pointer-events-none -translate-y-1/2"></motion.div>
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-radial from-[#C99A2E]/[0.03] to-transparent rounded-full blur-[80px] pointer-events-none"></motion.div>
            ...
            <div className="max-w-[1280px] mx-auto px-12 relative z-10">
                ...
                >
                    ...
                    <div className="w-full md:w-[48%] flex flex-col">
                        ...
                        <motion.div variants={item} className="mt-4 bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded p-10 shadow-[0_20px_40px_-10px_rgba(11,29,58,0.2)] relative overflow-hidden">
                            
                            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-0 w-32 h-32 bg-[#C99A2E]/20 rounded-full blur-[40px] pointer-events-none"></motion.div>
                            
                            <h3 className="text-[22px] font-bold mb-3 text-white relative z-10">{data.ctaHeading}</h3>
                            <p className="text-[15px] font-medium text-white/70 mb-8 relative z-10">{data.ctaDesc}</p>
                            
                            <button className="group relative overflow-hidden bg-white text-[#0B1D3A] px-8 py-4 rounded text-[14px] font-bold hover:shadow-[0_8px_20px_rgba(255,255,255,0.2)] active:scale-[0.98] transition-all flex items-center gap-3">

            ...
            <div className="max-w-[1280px] mx-auto px-12 relative z-10">
                ...
                >
                    ...
                    <div className="w-full md:w-[48%] flex flex-col">
                        ...
                        <motion.div variants={item} className="mt-4 bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded-[24px] p-10 shadow-[0_20px_40px_-10px_rgba(11,29,58,0.2)] relative overflow-hidden">
                            {/* Inner CTA Glow */}
                            ...
                            <button className="group relative overflow-hidden bg-white text-[#0B1D3A] px-8 py-4 rounded-xl text-[14px] font-bold hover:shadow-[0_8px_20px_rgba(255,255,255,0.2)] active:scale-[0.98] transition-all flex items-center gap-3">

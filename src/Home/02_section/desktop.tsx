                                ...
                                >
                                    ...
                                    <div className="flex flex-col relative z-10 w-full">
                                        <div className="flex items-center justify-between mb-0.5">
                                            <span className={`font-black text-[12.5px] tracking-[0.08em] transition-colors duration-300 ${isActive ? 'text-white' : 'text-white/40 group-hover:text-white/70'}`}>
                                                {tab.title}
                                            </span>
                                            {isActive && <ArrowRight size={13} className="text-[#D5AA45] opacity-80 animate-pulse" />}
                                        </div>
                                        <span className={`text-[10.5px] font-medium transition-colors duration-300 ${isActive ? 'text-[#D5AA45]' : 'text-white/30'}`}>
                                            {tab.subtitle}
                                        </span>
                                        <AnimatePresence>
                                            {isActive && (
                        ...
                        <div className="rounded-[4px] overflow-hidden safari-shadow border border-white/[0.12] flex flex-col h-full bg-[#0D2654] relative luxury-shadow-dark">
                            <div className="h-[44px] glass-safari-dark flex items-center px-4 relative border-b border-white/[0.06] shadow-[0_4px_24px_rgba(0,0,0,0.2)] z-20">
                                ...
                                <div className="flex items-center gap-3.5 absolute right-4 text-white/40">
                                    <Share2 size={13} strokeWidth={2} className="hover:text-white transition-colors cursor-pointer" />
                                    <Menu size={15} strokeWidth={2} className="hover:text-white transition-colors cursor-pointer" />
                                </div>
                            </div>

                            <div className="flex-1 p-6 lg:p-7 relative min-h-[500px] flex items-center justify-center overflow-hidden" style={{ background: 'radial-gradient(circle at top right, #112D60, #0D2654)' }}>
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-5">
                                                <div className="flex items-center gap-3.5">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-[18px] font-bold text-white tracking-tight">{data.browser.content['01'].title}</div>
                                                    </div>
                                                </div>
                                            ...
                                            {isSubmitted && !showReview ? (
                                                ...
                                                >
                                                    ...
                                                    <div className="text-[11px] font-black tracking-[0.2em] text-[#D5AA45] uppercase mb-1">Assessment Performance</div>
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <div className="grid grid-cols-2 gap-3.5 mb-4">
                                                        {currentQuestion.options.map((opt, i) => {
                                                            ...
                                                            if (isSubmitted) {
                                                                if (isCorrect) {
                                                                    btnStyle = 'bg-[#10B981]/25 border-[#10B981]/60 text-white shadow-[0_0_15px_rgba(16,185,129,0.25)]';
                                                                } else if (isSelected && !isCorrect) {
                                                                    btnStyle = 'bg-[#EF4444]/25 border-[#EF4444]/60 text-white shadow-[0_0_15px_rgba(239,68,68,0.25)]';
                                                                } else {
                                    ...
                                    {activeTab === '02' && (
                                        ...
                                        >
                                            ...
                                            <div className="flex flex-col gap-2.5 mb-4">
                                                <span className="text-[10px] font-black text-white/50 tracking-wider uppercase">Select Your Tactical Response:</span>
                                                {currentScenario.options.map((opt) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <p className="text-[12px] text-white/80 leading-relaxed">{opt.text}</p>
                                                        </button>
                                                    );
                                                })}
                                            </div>
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between mb-2">
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span className="text-[11px] font-black text-[#34D399] uppercase tracking-wider">Coach Priya's Feedback</span>
                                                            </div>
                                                    ...
                                                    return (
                                                        <div key={skill.id} className="w-full group">
                                                            <div className="flex justify-between items-center mb-1.5">
                                                                <div>
                                                                    <span className="text-[13px] font-bold text-white/95 group-hover:text-white transition-colors">{skill.label}</span>
                                                                    <div className="text-[10.5px] text-white/40">{skill.desc}</div>
                                                                </div>
                                            ...
                                            <div className="bg-white/[0.02] p-6 rounded-[4px] border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.2)] mb-4">
                                                <div className="flex items-center justify-between mb-4">
                                                    <div>
                                                        ...
                                                        <div className="text-[11px] text-white/40">Category: {activeHabit.category} · Click any day box to toggle progress</div>
                                                    </div>
                                                    <button
                                                ...
                                                <div className="grid grid-cols-10 gap-2">
                                                    {Array.from({ length: 30 }, (_, i) => i + 1).map((dayNum) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                <span className="text-[9px] font-black uppercase leading-none opacity-70">D</span>
                                                                <span className="text-[12px] font-black leading-tight">{dayNum}</span>
                                                                {isDone && <Check size={10} strokeWidth={3} className="text-[#071A49] -mt-0.5" />}
                                                            </button>
                                                        );
                                                    })}
                                                </div>

    ...
    >
      ...
      <div className="w-full max-w-[460px] flex flex-col z-10 text-center">
        ...
        >
          ...
          <p
            className="mt-3 font-medium text-[12.5px] leading-relaxed mx-auto max-w-[320px]"
              ...
              >
                ...
                <div className="flex items-center gap-3 relative z-10 w-full justify-between">
                  <div className="flex items-center gap-2.5">
                    <span
                      className={`text-xs font-black transition-colors duration-300 ${isActive ? "text-white" : "text-white/30"}`}
                    >
                      {tab.id}
                    </span>
                    <span
                      className={`font-bold text-[11.5px] tracking-wide transition-colors duration-300 ${isActive ? "text-white" : "text-white/60"}`}
                    >
                      {tab.title}
                    </span>
                  </div>
        ...
        >
          ...
          <div className="rounded overflow-hidden safari-shadow border border-white/[0.12] flex flex-col bg-[#0D2654] text-left relative luxury-shadow-dark z-10">
            ...
            <div
              className="flex-1 p-4 relative min-h-[440px] flex items-center justify-center overflow-hidden"
              style={{
                background:
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="text-[#6B8AFF] text-[8px] font-black tracking-[0.15em] mb-0.5">
                      ...
                      {!isSubmitted ? (
                        ...
                        <button
                          ...
                          className="p-1.5 rounded bg-white/[0.05] text-white/70 hover:text-white hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out"
                        >
                          <RotateCcw size={13} />
                        </button>
                      )}
                    ...
                    <div className="grid grid-cols-6 gap-1 mb-3.5 p-1 rounded bg-white/[0.02] border border-white/[0.05]">
                      {quizQuestions.map((_, i) => {
                        ...
                        if (isSubmitted) {
                          ...
                          pillBg =
                            "bg-gradient-to-r from-[#C99A2E] via-[#D5AA45] to-[#E4C46A] text-[#071A49] font-black border-[#E4C46A] shadow-[0_1px_8px_rgba(213,170,69,0.45)]";
                        } else if (isAnswered) {
                          pillBg =
                            "bg-[#D5AA45]/15 text-[#F3D887] border-[#D5AA45]/40 font-bold";
                        }
                        return (
                          <button
                            key={i}
                    ...
                    {isSubmitted && !showReview ? (
                      <div className="bg-white/[0.02] backdrop-blur-md p-5 rounded border border-white/[0.1] shadow-lg flex flex-col items-center text-center">
                        ...
                        <div className="text-[9px] font-black tracking-widest text-[#D5AA45] uppercase mb-0.5">
                        ...
                        <div className="text-[10.5px] font-medium text-[#F3D887] bg-[#D5AA45]/15 border border-[#D5AA45]/30 px-3 py-1 rounded-full mb-4 hover:shadow-[0_20px_40px_-12px_rgba(11,29,58,0.08)] hover:-translate-y-1 transition-all duration-400 ease-out">
                          {accuracy >= 80
                            ? "Master Real Estate Strategist"
                            : accuracy >= 50
                        ...
                        <div className="grid grid-cols-3 gap-2 w-full mb-4 text-center">
                          ...
                          <div className="bg-white/[0.03] p-2.5 rounded border border-white/[0.05]">
                            <div className="text-[14px] font-black text-[#EF4444]">
                          ...
                          <div className="bg-white/[0.03] p-2.5 rounded border border-white/[0.05]">
                            <div className="text-[14px] font-black text-[#6B8AFF]">
                              {answeredCount}
                            </div>
                            <div className="text-[9px] text-white/50">
                              Answered
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 w-full mt-1">
                          ...
                          <button
                            onClick={handleRestartQuiz}
                            className="w-full sm:w-auto px-3.5 py-2 rounded bg-white/[0.06] hover:bg-white/[0.12] text-white/90 hover:text-white font-semibold text-[11px] border border-white/15 transition-all flex items-center justify-center gap-1.5 cursor-pointer active:scale-[0.98] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out"
                          >
                            <RotateCcw size={12} />
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="bg-white/[0.02] backdrop-blur-sm p-4 rounded mb-3.5 border border-white/[0.08] shadow-[0_4px_16px_rgba(0,0,0,0.1)]">
                          <div className="flex items-center justify-between mb-1.5">
                            <span className="text-[9px] font-black text-[#D5AA45] tracking-wider uppercase">
                              Q {currentQIndex + 1} of {totalQuestions}
                            </span>
                            {isSubmitted && (
                              <span
                                className={`text-[9px] font-bold px-1.5 py-0.5 rounded ${userAnswers[currentQIndex] === currentQuestion.correctIndex ? "bg-[#10B981]/20 text-[#10B981]" : "bg-[#EF4444]/20 text-[#EF4444]"}`}
                              >
                          ...
                          <p className="text-[12px] font-medium leading-[1.5] text-white/90">
                        ...
                        <div className="flex flex-col gap-2 mb-3.5">
                          {currentQuestion.options.map((opt, i) => {
                            ...
                            if (isSubmitted) {
                              if (isCorrect) {
                                btnStyle =
                                  "bg-[#10B981]/25 border-[#10B981]/60 text-white";
                              } else if (isSelected && !isCorrect) {
                                btnStyle =
                                  "bg-[#EF4444]/25 border-[#EF4444]/60 text-white";
                              } else {
                                btnStyle =
                              ...
                              btnStyle =
                                "bg-[#D5AA45]/20 border-[#D5AA45] text-white";
                            }
                            return (
                              <button
                                key={i}
                              ...
                              >
                                <span
                                  className={`w-4 h-4 rounded flex items-center justify-center text-[9px] font-black shrink-0 ${isSelected ? "bg-[#D5AA45] text-[#071A49]" : "bg-white/10 text-white/60"}`}
                                >
                                  {letter}
                                </span>
                        ...
                        {isSubmitted && currentQuestion.explanation && (
                          <div className="bg-[#D5AA45]/10 border border-[#D5AA45]/30 p-3 rounded mb-3 text-[10.5px] leading-relaxed text-white/90">
                            <span className="font-bold text-[#F3D887] mr-1">
                              Explanation:
                            </span>
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="text-[#34D399] text-[8px] font-black tracking-[0.15em] mb-0.5">
                    ...
                    <div className="bg-[#0A1630] p-3.5 rounded border border-[#34D399]/25 shadow-[inset_0_0_15px_rgba(0,0,0,0.5)] mb-3">
                      <div className="text-[#34D399] text-[8.5px] font-black tracking-wider uppercase mb-1">
                        OBJECTION: {currentScenario.title}
                      </div>
                      <p className="text-[11.5px] text-white/90 leading-relaxed font-medium italic">
                    ...
                    {selectedResponseData && (
                      <div className="bg-[#0D2654] border border-[#34D399]/30 p-3 rounded">
                        ...
                        <p className="text-[10.5px] text-white/90 leading-snug">
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="text-[#A78BFA] text-[8px] font-black tracking-[0.15em] mb-0.5">
                          ...
                          <div key={skill.id} className="w-full">
                            <div className="flex justify-between items-center mb-1">
                              ...
                              <div className="flex gap-2">
                                ...
                                <span className="text-[9.5px] font-black text-[#A78BFA]">
                                  You: {currentVal}%
                                </span>
                              </div>
                            </div>
                ...
                {activeTab === "04" && (
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2.5">
                        <div
                          className="w-9 h-9 rounded flex items-center justify-center shadow-[0_0_10px_rgba(213,170,69,0.25)] border border-[#D5AA45]/30"
                          style={{
                            background: "rgba(213,170,69,0.15)",
                            color: "#D5AA45",
                          }}
                        >
                        ...
                        <div>
                          <div
                            className="text-[8px] font-black tracking-[0.15em] mb-0.5"
                            style={{ color: "#D5AA45" }}
                          >
                      ...
                      <div
                        className="flex items-center gap-1.5 px-2 py-1 rounded border border-[#D5AA45]/30 bg-[#D5AA45]/10 text-[10px] font-black"
                        style={{ color: "#D5AA45" }}
                      >
                        <Flame size={12} />
                    ...
                    <div className="bg-white/[0.02] p-3.5 rounded border border-white/[0.08] mb-3">
                      <div className="flex justify-between items-center mb-2.5">
                        ...
                        <span className="text-[9.5px] text-[#D5AA45] font-semibold">
                          {Math.round(

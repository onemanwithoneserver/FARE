...
export const dataEn = {
  ...
  headline: {
    ...
    line2: "YOU?",
    subtitle:
      "Explore tailored platforms built for companies, trainers, and real estate professionals.",
  },
  personas: [
    {
      id: "companies",
      ...
      color: "#0B1D3A",
      accent: "#10B981",
      items: ["Open Plot", "Residential", "Commercial", "Fractional", "Others"],
    },
    {
      id: "trainers",
...
export const dataTe = {
  ...
  headline: {
    ...
    line2: "ఉంది?",
    subtitle:
      "కంపెనీలు, ట్రైనర్లు మరియు రియల్ ఎస్టేట్ నిపుణుల కోసం ప్రత్యేకంగా రూపొందించిన ప్లాట్‌ఫారమ్‌లను అన్వేషించండి.",
  },
  personas: [
    {
      id: "companies",

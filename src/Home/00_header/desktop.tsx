            ...
            <div className="relative" ref={langDropdownRef}>
                ...
                <AnimatePresence>
                    {isLangDropdownOpen && (
                        ...
                        >
                            <div className={`text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 ${isScrolled ? 'text-white/70' : 'text-[#0B1D3A]/70'}`}>
                            ...
                            >
                                ...
                                {language === 'en' && (
                                    <Check size={14} strokeWidth={2.5} className={isScrolled ? 'text-[#0B1D3A]' : 'text-[#E2C068]'} />
                                )}
                            </button>
                            <button

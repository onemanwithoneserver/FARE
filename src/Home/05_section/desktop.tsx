        ...
        >
            <div className="max-w-[1300px] w-full mx-auto flex justify-between items-center relative z-10 min-h-[50px] gap-4">
                ...
                >
                    ...
                    <span className="text-[11.5px] font-normal hidden sm:inline-block" style={{ color: 'rgba(123, 141, 170, 0.7)' }}>
                ...
                >
                    {data.links.map((link, i) => (
                        <motion.button
                            ...
                            whileHover={{ y: -1 }}
                            className="text-[11.5px] font-normal transition-all duration-200 hover:text-white border-b border-dotted border-[#7B8DAA]/60 hover:border-white pb-[1px] cursor-pointer whitespace-nowrap"

...
import { GraduationCap, Upload, Tag, ArrowRight, CheckCircle } from 'lucide-react';
...
export default function RETrainersForm() {
    ...
    const expertiseOptions = [
        ...
        'Digital Marketing', 'Client Management', 'Property Law', 'Soft Skills'
    ];
            ...
            <div className="flex items-center gap-4 mb-8 relative z-10">
                ...
                <div>
                    <h2 className="text-2xl md:text-3xl font-black text-[#0B1D3A] leading-tight">
                        Trainer <span className="text-[#3B82F6] underline decoration-[#3B82F6]/30 decoration-[3px] underline-offset-4">Registration</span>
                    </h2>
                    <p className="text-[#475569] text-[14px]">Join the FARE network of elite real estate coaches</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label className="text-[12px] font-bold text-[#0B1D3A] uppercase tracking-wider">Full Name</label>
                ...
                <div className="space-y-2">
                    <label className="text-[12px] font-bold text-[#0B1D3A] uppercase tracking-wider">LinkedIn Profile URL</label>
                    <input required type="url" placeholder="https://linkedin.com/in/username" className="w-full bg-white border border-[#3B82F6]/20 rounded-xl py-3 px-4 text-[15px] text-[#0B1D3A] focus:outline-none focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/10 transition-all shadow-sm" />
                </div>

                <div className="space-y-2">
                    <label className="text-[12px] font-bold text-[#0B1D3A] uppercase tracking-wider">Upload Resume / Profile</label>
                    <div className="w-full border-2 border-dashed border-[#3B82F6]/30 rounded-xl py-8 px-4 flex flex-col items-center justify-center bg-white/50 hover:bg-[#F8FAFD] transition-colors cursor-pointer group">
                        ...
                        <span className="text-[14px] font-medium text-[#0B1D3A]">Click to upload or drag & drop</span>
                        <span className="text-[12px] text-[#475569] mt-1">PDF, DOCX up to 10MB</span>
                    </div>
                </div>

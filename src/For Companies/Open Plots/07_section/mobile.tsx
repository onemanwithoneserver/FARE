    ...
    >
      <div
        ...
        style={{
          ...
          maskImage:
            "linear-gradient(to bottom, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 25%, rgba(0,0,0,0) 75%, rgba(0,0,0,1) 100%)",
          WebkitMaskImage:
            "-webkit-linear-gradient(top, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 20%, rgba(0,0,0,0) 80%, rgba(0,0,0,1) 100%)",
        }}
      ></div>
      ...
      >
        ...
        >
          ...
          <motion.p
            variants={itemVariant}
            className="text-[15px] font-medium leading-[1.65] mb-10 text-[#475569] px-6 relative z-10"
          >
            {data.subtitle}
          </motion.p>
          <motion.div
            variants={itemVariant}
            className="flex flex-col gap-3.5 w-full px-6 relative z-10"
          >
            <motion.button
              whileTap={{ scale: 0.98 }}

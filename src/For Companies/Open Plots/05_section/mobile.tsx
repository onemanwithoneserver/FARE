...
import OpenPlotForm from "../../../Components/Forms/Mobile/OpenPlotForm";
...
export default function Mobile() {
  ...
  return (
    <section
      className="w-full py-6 relative font-['Outfit'] overflow-hidden"
      style={{
      ...
      <div className="w-full px-5 relative z-10 flex flex-col gap-8">
        ...
        >
              ...
              <React.Fragment key={i}>
                ...
                word.includes("Plot") ? (
                  <span className="text-[#C99A2E] relative inline-block">
                    {word}
                    <svg
                      className="absolute w-full h-[4px] -bottom-0.5 left-0 text-[#C99A2E]/30"
                      viewBox="0 0 100 10"
          ...
          <motion.div variants={item} className="mb-4 flex flex-col gap-2">
            ...
            <p
              className="text-[15px] font-medium leading-[1.65]"
              style={{ color: "#475569" }}
            >
              {data.desc2}
            </p>
          ...
          <motion.div variants={item} className="flex flex-col gap-2.5 mb-6">
            {data.testAreas.map((area, idx) => (
              <div key={idx} className="flex items-start gap-3">
                ...
                <span className="text-[14.5px] font-semibold text-[#0B1D3A]/90">
                  {area}
                </span>
              </div>
            ))}
          ...
          <motion.p
            variants={item}
            className="text-[12px] font-medium italic text-center text-[#64748B] px-4"
          >
            {data.footerText}
          </motion.p>
        </motion.div>
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded p-5 shadow-[0_15px_40px_-10px_rgba(11,29,58,0.12)] border border-white relative z-10 overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-5 relative z-10">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-[17px] font-bold text-[#0B1D3A] mb-0.5">

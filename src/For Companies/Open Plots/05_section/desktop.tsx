...
export default function Desktop() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="max-w-[1280px] mx-auto px-12 relative z-10 flex items-center justify-between gap-16">
        <motion.div
          variants={container}
          initial="hidden"
          whileInView="show"
        ...
        >
          ...
          <motion.h2
            variants={item}
            className="text-[2.5rem] lg:text-[3rem] leading-[1.08] font-black tracking-[-0.02em] mb-4"
            style={{ color: NAVY }}
          >
          ...
          <motion.div variants={item} className="mb-6 flex flex-col gap-2">
            ...
            <p
              className="text-[17px] font-medium leading-[1.65]"
              style={{ color: "#475569" }}
            >
              {data.desc2}
            </p>
          ...
          <motion.div
            variants={item}
            className="grid grid-cols-2 gap-y-3 gap-x-6 mb-8"
          >
              ...
              <div key={idx} className="flex items-start gap-3 group">
                <div className="w-5 h-5 rounded-full bg-[#10B981]/10 border border-[#10B981]/30 flex items-center justify-center shrink-0 mt-0.5 group-hover:bg-[#10B981] group-hover:border-[#10B981] transition-colors duration-300">
                  <CheckCircle2
                    size={13}
                    strokeWidth={3}
                    className="text-[#10B981] group-hover:text-white transition-colors duration-300"
                  />
                </div>
                <span className="text-[16px] font-semibold text-[#0B1D3A]/80 group-hover:text-[#0B1D3A] transition-colors duration-300">
                  {area}
                </span>
              </div>
            ))}
          ...
          <motion.p
            variants={item}
            className="text-[13px] font-medium italic text-[#64748B]"
          >
            {data.footerText}
          </motion.p>
        </motion.div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13.5px] font-medium text-[#64748B]">
                    {data.illustrationData.subtitle}
                  </p>
                </div>
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      ></div>
                      <span className="text-[16px] font-bold text-[#0B1D3A] ml-1">
                        {step}
                      </span>
                    </div>
                  </div>

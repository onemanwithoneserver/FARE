...
export default function Desktop() {
  ...
  return (
    ...
    >
      <motion.div
        animate={{ opacity: [0.22, 0.45, 0.22], scale: [1, 1.08, 1] }}
        transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
        className="absolute -top-[10%] right-[-5%] w-[700px] h-[700px] bg-gradient-radial from-rose-500/25 via-red-500/10 to-transparent rounded-full blur-[130px] pointer-events-none z-0"
      ></motion.div>
      <motion.div
        animate={{ opacity: [0.18, 0.38, 0.18], scale: [1.05, 1, 1.05] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        className="absolute -bottom-[10%] left-[-5%] w-[650px] h-[650px] bg-gradient-radial from-red-600/20 via-rose-500/10 to-transparent rounded-full blur-[120px] pointer-events-none z-0"
      ></motion.div>
      <motion.div
        animate={{ opacity: [0.12, 0.28, 0.12], scale: [1, 1.1, 1] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-[40%] left-[20%] w-[500px] h-[500px] bg-gradient-radial from-red-400/15 to-transparent rounded-full blur-[100px] pointer-events-none z-0"
      ></motion.div>
      <motion.div
        animate={{ scale: [1, 1.35, 1], opacity: [0.06, 0.18, 0.06] }}
        transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] rounded-full border border-red-500/30 pointer-events-none z-0"
      />
      <motion.div
        animate={{ scale: [1, 1.55, 1], opacity: [0.03, 0.12, 0.03] }}
        transition={{
          duration: 8,
          repeat: Infinity,
          ease: "easeInOut",
        ...
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[750px] rounded-full border border-rose-500/20 pointer-events-none z-0"
      />
      <div
      ...
      <div className="max-w-[1000px] mx-auto px-12 relative z-10">
        ...
        >
          ...
          <motion.p
            variants={item}
            className="text-[18px] font-medium leading-[1.65] max-w-[650px] text-[#475569]"
          >
            {data.subtitle}
          </motion.p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="absolute top-0 right-0 w-32 h-32 bg-gradient-radial from-red-500/20 to-transparent rounded-bl-full blur-[20px] pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                ></motion.div>
        ...
        >
          <motion.div
            ...
            transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
            className="absolute top-0 right-0 w-72 h-72 bg-[#C99A2E]/10 rounded-full blur-[60px] pointer-events-none"
          ></motion.div>
          <motion.div
            animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}
            transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
            className="absolute bottom-0 left-0 w-72 h-72 bg-[#60A5FA]/10 rounded-full blur-[60px] pointer-events-none"
          ></motion.div>
          <motion.div
            animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}

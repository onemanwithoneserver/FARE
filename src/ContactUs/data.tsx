...
export const dataEn = {
  ...
  form: {
    ...
    reasons: [
      {
        ...
        color: "#3B82F6",
        tags: ["Enterprise LMS", "Custom Curriculum", "Platform Pricing", "Live Demo Pilot"]
      },
      {
        id: "growth",
        ...
        color: "#10B981",
        tags: ["Developer Syndicate", "CP Network", "Diagnostic Labs", "Regional Partnership"]
      },
      {
        id: "business",
        ...
        color: "#8B5CF6",
        tags: ["Institutional Alliance", "Media & Press", "Custom Engagement", "Leadership Interview"]
      },
      {
        id: "careers",
        ...
        color: "#F59E0B",
        tags: ["Master Trainer", "Industry Coach", "Faculty Accreditation", "Curriculum Design"]
      }
    ],
    section02: {
      number: "02 /",
      title: "YOUR DETAILS",
      nameLabel: "Full Name",
      namePlaceholder: "e.g. Rahul Varma",
      emailLabel: "Official Email",
      emailPlaceholder: "e.g. rahul@company.com",
      companyLabel: "Company / Organization",
      optionalText: "(optional)",
      companyPlaceholder: "e.g. Brigade Group, Prestige Estates, or Independent Practice",
    ...
    confirmation: {
      ...
      titlePrefix: "Briefing Forwarded to",
      titleSuffix: "Desk",
      thankYou: "Thank you",
      bodyText: "Your inquiry has been registered under priority dispatch. A designated FARE advisor will contact you within two business days at",
  ...
  sidebar: {
    ...
    partnersNote: "Growth Partner & Corporate Trainer inquiries are routed directly to executive partnerships."
  }
};
...
export const dataTe = {
  ...
  form: {
    section01: {
      number: "01 /",
      title: "ఇది దేనికి సంబంధించింది",
      selected: "ఎంపిక చేయబడింది",
      suggestedTopicsLabel: "సూచించిన అంశాలు:"
    },
    reasons: [
      {
        id: "platform",
        title: "ప్లాట్‌ఫారమ్‌ను ఉపయోగించడం",
        desc: "లైవ్ FARE లెర్నింగ్ ప్లాట్‌ఫారమ్‌ల కోసం యాక్సెస్, ధరలు, LMS ఇంటిగ్రేషన్ లేదా మద్దతు.",
        color: "#3B82F6",
        tags: ["Enterprise LMS", "కస్టమ్ కరికులమ్", "ప్లాట్‌ఫారమ్ ధరలు", "లైవ్ డెమో పైలట్"]
      },
      {
        id: "growth",
        title: "గ్రోత్ పార్ట్నర్",
        desc: "మీరు ఇప్పటికే సేవలు అందిస్తున్న డెవలపర్లు మరియు సంస్థలకు FARE డయాగ్నస్టిక్ ల్యాబ్స్‌ను పరిచయం చేయడం.",
        color: "#10B981",
        tags: ["డెవలపర్ సిండికేట్", "CP నెట్‌వర్క్", "డయాగ్నస్టిక్ ల్యాబ్స్", "ప్రాంతీయ భాగస్వామ్యం"]
      },
      {
        id: "business",
        title: "బిజినెస్ & ప్రెస్",
        desc: "సంస్థాగత భాగస్వామ్యాలు, మీడియా విచారణలు లేదా కస్టమ్ వాణిజ్య ఒప్పందాలు.",
        color: "#8B5CF6",
        tags: ["సంస్థాగత భాగస్వామ్యం", "మీడియా & ప్రెస్", "కస్టమ్ ఎంగేజ్‌మెంట్", "లీడర్‌షిప్ ఇంటర్వ్యూ"]
      },
      {
        id: "careers",
        title: "కెరీర్స్ & ఫ్యాకల్టీ",
        desc: "గుర్తింపు పొందిన మాస్టర్ ట్రైనర్, ఇండస్ట్రీ కోచ్ లేదా కోర్ టీమ్ మెంబర్‌గా FARE లో చేరండి.",
        color: "#F59E0B",
        tags: ["మాస్టర్ ట్రైనర్", "ఇండస్ట్రీ కోచ్", "ఫ్యాకల్టీ అక్రిడిటేషన్", "కరికులమ్ డిజైన్"]
      }
    ],
    section02: {
      number: "02 /",
      ...
      companyPlaceholder: "ఉదా. బ్రిగేడ్ గ్రూప్, ప్రెస్టీజ్ ఎస్టేట్స్, లేదా స్వతంత్ర ప్రాక్టీస్",
    ...
    confirmation: {
      badge: "విచారణ నమోదైంది",
      titlePrefix: "బ్రీఫింగ్",
      titleSuffix: "డెస్క్‌కు పంపబడింది",
      thankYou: "ధన్యవాదాలు",
      bodyText: "మీ విచారణ ప్రాధాన్యతా పద్ధతిలో నమోదు చేయబడింది. కేటాయించబడిన FARE సలహాదారు రెండు పని దినాలలో మిమ్మల్ని సంప్రదిస్తారు:",
      resetBtn: "మరొక విచారణను పంపండి"
    }
  },
  sidebar: {
    ...
    partnersNote: "గ్రోత్ పార్ట్నర్ & కార్పొరేట్ ట్రైనర్ విచారణలు నేరుగా ఎగ్జిక్యూటివ్ భాగస్వామ్య బృందానికి చేరుతాయి."
  }
};

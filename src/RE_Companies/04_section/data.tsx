...
export const dataEn = {
  ...
  subtitle:
    "Use the tabs to explore how FARE can fit into your learning ecosystem.",
...
export const dataTe = {
  ...
  subtitle:
    "FARE మీ లెర్నింగ్ ఎకోసిస్టమ్‌లో ఎలా సరిపోతుందో తెలుసుకోవడానికి ట్యాబ్‌లను ఉపయోగించండి.",
  journeyLabel: "జర్నీ",
  ...
  tabContent: {
    tab1: {
      title:
        "మీ ప్రాజెక్ట్ నాలెడ్జ్‌ను ఒక స్ట్రక్చర్డ్ లెర్నింగ్ జర్నీలో ఉంచండి.",

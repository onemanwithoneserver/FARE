...
export const dataEn = {
    ...
    subtitle: "Whether you're providing project knowledge, engaging teams, practicing skills, or sourcing trainers — FARE offers a comprehensive solution.",
    cards: [
        {
            tag: "KNOW",
...
export const dataTe = {
    ...
    subtitle: "మీరు ప్రాజెక్ట్ నాలెడ్జ్ అందించాలన్నా, టీమ్‌ను ఎంగేజ్ చేయాలన్నా, స్కిల్స్ ప్రాక్టీస్ చేయాలన్నా లేదా ట్రైనర్స్‌ను వెతకాలన్నా — FARE సమగ్ర పరిష్కారాన్ని అందిస్తుంది.",
    cards: [
        {
            tag: "KNOW",

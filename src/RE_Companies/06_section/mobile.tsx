                ...
                >
                    <div className="flex flex-col">
                        ...
                        <motion.div variants={item} className="mb-5">
                            <p className="text-[16px] font-bold mb-3.5" style={{ color: NAVY }}>{data.desc1}</p>
                            ...
                            <div className="bg-[#F8FAFD] rounded p-3.5 border border-[#0B1D3A]/[0.06] flex items-start gap-2.5">
                    ...
                    >
                        ...
                        <h3 className="text-[18px] font-bold mb-5 relative z-10 flex items-center gap-3" style={{ color: NAVY }}>
                    ...
                    <motion.div variants={item} className="bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded p-7 shadow-[0_15px_30px_-10px_rgba(11,29,58,0.2)] flex flex-col items-center text-center relative overflow-hidden">
                        ...
                        <h3 className="text-[18px] font-bold mb-2.5 text-white relative z-10">{data.ctaHeading}</h3>
                        <p className="text-[13.5px] font-medium text-white/70 mb-5 relative z-10">{data.ctaDesc}</p>

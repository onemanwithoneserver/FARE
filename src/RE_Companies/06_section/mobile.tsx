                ...
                >
                    ...
                    <motion.div variants={item} className="bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded-[20px] p-8 shadow-[0_15px_30px_-10px_rgba(11,29,58,0.2)] flex flex-col items-center text-center relative overflow-hidden">
                        ...
                        <div className="flex flex-col w-full gap-3 relative z-10">
                            <button className="group w-full bg-white text-[#0B1D3A] py-4 rounded-xl text-[14px] font-bold flex items-center justify-center gap-2 shadow-sm active:scale-[0.98] transition-all">
                            ...
                            {data.secondaryCtaButton && (
                                <button className="w-full bg-white/10 border border-white/20 text-white py-4 rounded-xl text-[14px] font-bold active:scale-[0.98] transition-all flex items-center justify-center gap-2">
                                    {data.secondaryCtaButton}
                                </button>
                            )}
                        </div>

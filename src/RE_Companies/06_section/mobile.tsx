      ...
      <div className="w-full px-5 relative z-10">
        ...
        >
          ...
          >
            ...
            <h3
              className="text-[18px] font-bold mb-5 relative z-10 flex items-center gap-3"
              style={{ color: NAVY }}
            >
              <div
          ...
          >
            ...
            ></motion.div>
            <h3 className="text-[18px] font-bold mb-2.5 text-white relative z-10">
              {data.ctaHeading}
            </h3>
            <p className="text-[13.5px] font-medium text-white/70 mb-5 relative z-10">
              {data.ctaDesc}
            </p>

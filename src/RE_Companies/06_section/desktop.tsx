      ...
      <div className="max-w-[1280px] mx-auto px-12 relative z-10">
        ...
        >
          <div className="w-full md:w-[48%] flex flex-col">
            ...
            <motion.h2
              variants={item}
              className="text-[3rem] lg:text-[3.5rem] leading-[1.08] font-black tracking-[-0.02em] mb-4"
              style={{ color: NAVY }}
            >
              {data.headline}
            </motion.h2>
            <motion.div variants={item} className="mb-8">
              <p className="text-[18px] font-bold mb-4" style={{ color: NAVY }}>
                {data.desc1}
              </p>
            ...
            <motion.div
              variants={item}
              className="mt-2 bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded p-8 shadow-[0_20px_40px_-10px_rgba(11,29,58,0.2)] relative overflow-hidden flex flex-col gap-5"
            >
              <motion.div
                animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}
                transition={{
              ...
              ></motion.div>
              <div>
                <h3 className="text-[22px] font-bold mb-2 text-white relative z-10">
                  {data.ctaHeading}
                </h3>
                <p className="text-[15px] font-medium text-white/70 relative z-10">
                  {data.ctaDesc}
                </p>
              </div>
              <div className="flex flex-col gap-3 w-full">
                <button className="group relative overflow-hidden bg-white text-[#0B1D3A] w-full py-4 rounded text-[14px] font-bold hover:shadow-[0_8px_20px_rgba(255,255,255,0.2)] active:scale-[0.98] transition-all flex items-center justify-center gap-3 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out">
                ...
                {data.secondaryCtaButton && (
                  <button className="bg-white/10 border border-white/20 text-white w-full py-4 rounded text-[14px] font-bold hover:bg-white/20 active:scale-[0.98] transition-all flex items-center justify-center gap-2 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out">
                    {data.secondaryCtaButton}
                  </button>
                )}
              </div>
          ...
          <div className="w-full md:w-[52%] flex flex-col justify-center">
            ...
            >
              ...
              <h3
                className="text-[24px] font-bold mb-8 relative z-10 flex items-center gap-3.5"
                style={{ color: NAVY }}
              >
                <div

...
export const dataEn = {
  ...
  highlights:
    "Projects · Products · Sales Process · Channel Partner Program · Team Structure · Training Requirements",
...
export const dataTe = {
  ...
  headline:
    "ప్రతి ప్రాజెక్ట్ భిన్నంగా ఉంటుంది. మీ లెర్నింగ్ సిస్టమ్ కూడా అలానే ఉండవచ్చు.",
  desc1: "FARE వీటి ఆధారంగా కస్టమైజ్ చేయబడుతుంది:",
  highlights:
    "ప్రాజెక్ట్స్ · ప్రొడక్ట్స్ · సేల్స్ ప్రాసెస్ · ఛానల్ పార్ట్నర్ ప్రోగ్రామ్ · టీమ్ స్ట్రక్చర్ · ట్రైనింగ్ రిక్వైర్‌మెంట్స్",
  desc2:
    "మీ నిర్దిష్ట ఆపరేషనల్ అవసరాలకు సరిపోయేలా ప్లాట్‌ఫారమ్‌ను అనుకూలీకరించండి.",

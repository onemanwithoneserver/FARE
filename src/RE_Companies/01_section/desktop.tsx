                        ...
                        <h1 className={`font-black mb-3 flex flex-col gap-1 md:gap-1.5 ${
                            language === 'te'
                                ...
                                <>
                                    ...
                                    <motion.span variants={item} className="block uppercase" style={{ color: NAVY }}>{language === 'te' ? 'రెసిడెన్షియల్ &' : 'RESIDENTIAL &'}</motion.span>
                                    <motion.span variants={item} className={`inline-block text-[#C99A2E] gold-underline uppercase ${language === 'te' ? 'pb-1' : ''}`}>
                                        {language === 'te' ? 'కమర్షియల్ రియల్ ఎస్టేట్' : 'COMMERCIAL REAL ESTATE'}
                                    </motion.span>
                                </>
                        </h1>

  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute top-[20%] left-[-10%] w-[600px] h-[600px] bg-gradient-radial from-[#3B82F6]/[0.03] to-transparent rounded-full blur-[100px] pointer-events-none z-0"
      ></motion.div>
      <motion.div
        animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}
        transition={{ duration: 4, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-[40%] right-[-5%] w-[500px] h-[500px] bg-gradient-radial from-[#C99A2E]/[0.05] to-transparent rounded-full blur-[80px] pointer-events-none z-0"
      ></motion.div>
            ...
            >
              ...
              >
                <ChevronRight
                  size={16}
                  strokeWidth={3}
                  className="text-[#C99A2E]/50 -mr-2"
                />
                <ChevronRight
                  size={16}
                  strokeWidth={3}
                  className="text-[#C99A2E]/80 -mr-2"
                />
                <ChevronRight
                  size={16}
                  strokeWidth={3}
            ...
            >
              <div className="w-[90px] h-[90px] rounded-full bg-white/60 backdrop-blur-sm border border-[#0B1D3A]/5 flex items-center justify-center mb-8 shadow-[0_8px_20px_-8px_rgba(11,29,58,0.1)] group-hover:shadow-[0_15px_30px_-10px_rgba(11,29,58,0.15)] group-hover:-translate-y-2 transition-all duration-400 relative">
                ...
                <div className="w-[70px] h-[70px] rounded-full bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] flex items-center justify-center shadow-inner relative overflow-hidden">
                  ...
                  <span className="text-white text-[28px] font-bold font-serif relative z-10">
                    {step.number}
                  </span>
                </div>
              </div>
        ...
        <div className="mt-32 flex justify-center">
          <div className="group relative">
            <motion.div
              animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}
              transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
              className="absolute inset-0 bg-gradient-to-r from-transparent via-[#C99A2E]/20 to-transparent blur-[20px] group-hover:blur-[30px] transition-all duration-500 opacity-0 group-hover:opacity-100"
            ></motion.div>
            <motion.div
                ...
                return (
                  <div key={idx} className="flex items-center gap-3 md:gap-4">
                    <motion.div
                      ...
                      animate={
                        isActive ? { scale: 1.06, y: -2 } : { scale: 1, y: 0 }
                      }
                    ...
                    >
                      ...
                      <span
                        className={`font-bold text-[13px] uppercase tracking-[0.16em] ${isActive ? "text-white" : ""}`}
                      >
                        {label}
                      </span>
                    </motion.div>

      ...
      <div className="w-full flex flex-col lg:flex-row items-center justify-between relative z-10 pt-4 lg:pt-8 pb-8 lg:pb-12 pl-6 sm:pl-10 lg:pl-14 xl:pl-20 pr-0">
        ...
        >
          ...
          <motion.div variants={item} className="flex items-center gap-4 mb-6">
            <button
              className="text-white text-[14px] font-semibold px-8 py-3.5 rounded-[4px] flex items-center gap-2.5 hover:shadow-[0_12px_32px_rgba(201,154,46,0.25)] hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out"
              style={{
          ...
          <motion.span
            variants={item}
            className="text-[11px] font-semibold text-[#0B1D3A]/35 uppercase tracking-[0.15em] leading-relaxed"
          >
            {data.supporting}
          </motion.span>
        </motion.div>

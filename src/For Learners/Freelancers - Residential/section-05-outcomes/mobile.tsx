  ...
  return (
    <section className="w-full bg-[#F8FAFD] py-16 px-6 font-['Outfit']">
      <div className="max-w-full mx-auto">
          ...
          {data.outcomes.map((o, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white p-6 rounded-xl border border-[#E2E8F0]/80 shadow-[0_2px_8px_rgba(11,29,58,0.02)]"
              >
        ...
        >
          <p className="text-[15px] font-bold text-[#C99A2E] bg-white border border-[#E2E8F0]/80 shadow-sm inline-block px-5 py-3 rounded-lg leading-relaxed">
            "{data.quote}"
          </p>
        </motion.div>
      </div>

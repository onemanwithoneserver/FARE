      ...
      <div className="max-w-full mx-auto">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3.5 mb-3.5">
                  ...
                  <h3 className="text-[15px] font-bold text-[#0B1D3A] leading-tight">{c.title}</h3>
                </div>
        ...
        >
          {data.quotes.map((quote, i) => (
            <p key={i} className={`text-[15px] font-bold ${i === 0 ? "text-[#C99A2E]" : "text-[#0B1D3A]"} leading-relaxed`}>
              {i === 0 ? `"${quote}"` : quote}
            </p>
          ))}
        </motion.div>

...
export const dataEn = {
  ...
  headline:
    "From Traditional Real Estate Skills to New-Age Digital Capabilities",
  subtitle:
    "FARE gives trainers the flexibility to create programs across the complete real estate skill ecosystem.",
  categories: [
    {
      title: "Sales Skills",
      color: "#34D399",
...
export const dataTe = {
  ...
  headline:
    "సాంప్రదాయ రియల్ ఎస్టేట్ నైపుణ్యాల నుండి కొత్త-తరం డిజిటల్ సామర్థ్యాల వరకు",
  subtitle:
    "FARE శిక్షకులకు పూర్తి రియల్ ఎస్టేట్ స్కిల్ ఎకోసిస్టమ్‌లో ప్రోగ్రామ్‌లను సృష్టించే సౌలభ్యాన్ని అందిస్తుంది.",
  categories: [
    {
      ...
      subcategories: [
        {
          ...
          skills: [
            ...
            "కస్టమర్ ప్రొఫైలింగ్",
            "అవసరాల విశ్లేషణ",
            "ప్రాపర్టీ ప్రెజెంటేషన్",
            "సైట్ విజిట్ నైపుణ్యాలు",
      ...
      subcategories: [
        {
          ...
          skills: [
            ...
            "సోషల్ సెల్లింగ్",
            "డిజిటల్ మార్కెటింగ్",
            "పెర్ఫార్మెన్స్ మార్కెటింగ్",
            "కంటెంట్ మార్కెటింగ్",
            "పర్సనల్ బ్రాండింగ్",
            "లీడ్ జనరేషన్",
            "మార్కెటింగ్ ఆటోమేషన్",
            "CRM",
            "రియల్ ఎస్టేట్ కోసం AI",
            "ప్రాప్‌టెక్",
            "డేటా & అనలిటిక్స్",
            "వీడియో సెల్లింగ్",
            "వాట్సాప్ & మెసేజింగ్",
      ...
      subcategories: [
        {
          ...
          skills: [
            ...
            "లీడర్‌షిప్",
            "కోచింగ్",
            "పెర్ఫార్మెన్స్ మేనేజ్‌మెంట్",
            "గోల్ సెట్టింగ్",
            "సేల్స్ మేనేజ్‌మెంట్",
            "కాంఫ్లిక్ట్ మేనేజ్‌మెంట్",
            "డెలిగేషన్",
            "నిర్ణయాలు తీసుకోవడం",
            "టీమ్ బిల్డింగ్",
      ...
      subcategories: [
        {
          ...
          skills: [
            ...
            "అనుబంధ నిర్వహణ (Relationship Management)",
            "క్లయింట్ రిటెన్షన్",

  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute -top-[10%] right-[-5%] w-[800px] h-[800px] bg-gradient-radial from-rose-500/25 via-red-500/10 to-transparent rounded-full blur-[130px] pointer-events-none z-0"
      ></motion.div>
      <motion.div

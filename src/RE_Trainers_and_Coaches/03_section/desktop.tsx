...
export default function Desktop() {
  ...
  const icons = {
    ...
    Link2: (
      <Link2 size={24} strokeWidth={2.2} className="text-white relative z-10" />
    ),
    Target: (
      <Target
        size={24}
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute top-0 left-[-10%] w-[800px] h-[800px] bg-gradient-radial from-[#F1F5FB]/80 to-transparent rounded-full blur-[100px] pointer-events-none"
      ></motion.div>
      <motion.div
        animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }}
        transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
        className="absolute bottom-[-20%] right-[-10%] w-[600px] h-[600px] bg-gradient-radial from-[#C99A2E]/[0.03] to-transparent rounded-full blur-[100px] pointer-events-none"
      ></motion.div>

    ...
    <section className="w-full py-16 bg-[#F8FAFD] relative font-['Outfit'] overflow-hidden">
      ...
      <div className="max-w-[1320px] mx-auto px-12 relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={item}
            className="text-[3.5rem] lg:text-[4.5rem] leading-[1.05] font-black tracking-[-0.03em] mb-8"
            style={{ color: NAVY }}
          >
          ...
          <motion.p
            variants={item}
            className="text-[22px] font-medium leading-[1.65] text-[#475569] mb-10 max-w-[850px] mx-auto"
          >
            {data.description}
          </motion.p>
        </motion.div>
        <div className="max-w-[1100px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          >
            ...
            <h3
              className="text-[26px] font-bold mb-10 relative z-10"
              style={{ color: NAVY }}
            >
              {data.exploreHeading}
            </h3>

      ...
      <div className="px-5 relative z-10">
        ...
        >
          <motion.div variants={item} className="mb-6">
            <div className="bg-white border border-[#0B1D3A]/[0.08] px-4 py-2 rounded-full flex items-center gap-2 shadow-sm backdrop-blur-md inline-flex hover:shadow-[0_20px_40px_-12px_rgba(11,29,58,0.08)] hover:-translate-y-1 transition-all duration-400 ease-out">
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <button className="w-full bg-gradient-to-r from-[#C99A2E] to-[#B88A22] active:scale-95 text-white px-6 py-4 rounded font-bold text-[16px] shadow-[0_10px_20px_-5px_rgba(201,154,46,0.4)] flex items-center justify-center gap-3 relative z-10 transition-transform hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] transition-all duration-300 ease-out">

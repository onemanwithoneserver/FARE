...
export default function Desktop() {
    ...
    return (
        <section className="w-full py-32 bg-[#F8FAFD] relative font-['Outfit'] overflow-hidden">
            <div className="absolute top-1/4 -right-[200px] w-[600px] h-[600px] bg-gradient-radial from-[#E0E7FF]/50 to-transparent rounded-full blur-[80px] pointer-events-none"></div>
            ...
            <div className="max-w-[1240px] mx-auto px-12 relative z-10">
                ...
                >
                    ...
                    <motion.h2 variants={item} className="text-[3rem] lg:text-[3.5rem] leading-[1.08] font-black tracking-[-0.02em] mb-6 max-w-[900px]" style={{ color: NAVY }}>
                        {data.headline}
                    </motion.h2>
                </motion.div>
                ...
                <div className="mb-24">
                    <motion.h3 
                        ...
                        viewport={{ once: false }}
                        className="text-[24px] font-bold mb-10 text-center" style={{ color: NAVY }}
                    >
                    ...
                    >
                        {data.segments.map((segment, index) => (
                            <motion.div
                                key={index}
                                variants={item}
                                className="bg-white border border-[#0B1D3A]/10 rounded-2xl p-6 shadow-[0_4px_20px_-4px_rgba(11,29,58,0.03)] hover:shadow-[0_15px_30px_-10px_rgba(11,29,58,0.08)] transition-all duration-300"
                            >
                                ...
                                <h4 className="text-[18px] font-bold mb-4" style={{ color: NAVY }}>
                                    {segment.title}
                                </h4>
                                <div className="flex flex-col gap-2.5">
                                    {segment.items.map((it, idx) => (
                                        <div key={idx} className="flex items-center gap-2 text-[14px] font-medium text-[#596780]">
                ...
                <div className="relative">
                    <div className="absolute inset-0 bg-[#0B1D3A] rounded-3xl transform -rotate-1 opacity-5 blur-sm"></div>
                    <div className="bg-gradient-to-br from-[#0B1D3A] to-[#0F2751] rounded-3xl p-12 lg:p-16 relative overflow-hidden shadow-2xl">

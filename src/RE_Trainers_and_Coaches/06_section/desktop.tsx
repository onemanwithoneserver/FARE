    ...
    >
      ...
      <div className="max-w-[1320px] mx-auto px-12 relative z-10">
        ...
        >
          ...
          <motion.h2
            variants={item}
            className="text-[3rem] lg:text-[3.75rem] leading-[1.05] font-black tracking-[-0.02em] mb-8 max-w-[900px] text-[#0B1D3A]"
          >
            {data.headline}
          </motion.h2>
          <motion.p
            variants={item}
            className="text-[18px] font-medium leading-[1.65] text-[#475569] max-w-[800px]"
          >
            {data.title}
          </motion.p>
        </motion.div>

...
export default function Desktop() {
    ...
    return (
        <section className="w-full py-16 relative font-['Outfit'] overflow-hidden bg-[#020b1e]">
            ...
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }} className="absolute top-[20%] right-[-10%] w-[800px] h-[800px] bg-gradient-radial from-[#C99A2E]/20 to-transparent rounded-full blur-[120px] pointer-events-none z-0"></motion.div>
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 5, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-[20%] left-[-10%] w-[600px] h-[600px] bg-gradient-radial from-[#071A49]/40 to-transparent rounded-full blur-[100px] pointer-events-none z-0"></motion.div>
            ...
            <div className="max-w-[1320px] mx-auto px-12 relative z-10">
                ...
                >
                    ...
                    <motion.h2 variants={item} className="text-[3rem] lg:text-[3.75rem] leading-[1.05] font-black tracking-[-0.02em] mb-8 max-w-[900px] text-white">
                        {data.headline}
                    </motion.h2>
                    ...
                    >
                        {data.modes.map((mode, index) => (
                            <motion.div
                                ...
                                className="bg-[#071A49]/60 backdrop-blur-sm border border-white/10 rounded p-10 hover:bg-[#071A49]/70 transition-all duration-400 relative overflow-hidden text-center group shadow-[0_10px_40px_-10px_rgba(2,6,23,0.45)] cursor-default"
                            >
                                ...
                                <p className="text-[16px] font-medium text-white/70 leading-relaxed group-hover:text-white transition-colors duration-300">
                                    {mode.desc}
                                </p>
                            </motion.div>
                        ))}
                    ...
                    >
                        {data.types.map((type, index) => (
                            <motion.div
                                key={index}
                                variants={item}
                                className="bg-[#071A49]/40 backdrop-blur-sm border border-white/10 rounded p-8 hover:bg-[#071A49]/60 hover:border-white/20 hover:shadow-[0_15px_30px_-10px_rgba(2,6,23,0.35)] transition-all duration-400 flex flex-col h-full group"
                            >
                                ...
                                <p className="text-[15px] font-medium text-white/70 leading-relaxed group-hover:text-white transition-colors duration-300">
                                    {type.desc}
                                </p>
                            </motion.div>
                        ))}
                ...
                >
                    ...
                    <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-0 left-0 w-64 h-64 bg-[#071A49]/40 rounded-full blur-[60px] group-hover:bg-[#071A49]/60 transition-colors duration-700 pointer-events-none"></motion.div>

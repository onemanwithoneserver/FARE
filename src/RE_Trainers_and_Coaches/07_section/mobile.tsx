            ...
            {data.tabs.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[13px] font-bold leading-tight transition-colors duration-300 relative z-10 ${isActive ? "text-white" : "text-[#0B1D3A]"}`}
                  >
                    {tab.label}
                  </span>
                </button>
          ...
          <div className="bg-white border border-[#0B1D3A]/[0.06] rounded p-6 sm:p-8 relative overflow-hidden shadow-[0_4px_20px_-10px_rgba(11,29,58,0.05)]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                ></motion.div>
                <h3
                  className="text-[24px] font-black mb-4 leading-tight"
                  style={{ color: NAVY }}
                >
                  {activeTabData.title}
                </h3>

...
export default function Mobile() {
    ...
    return (
        <section className="w-full py-10 bg-[#F8FAFD] relative font-['Outfit'] overflow-hidden">
            <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-[-100px] w-[300px] h-[300px] bg-gradient-radial from-[#C99A2E]/[0.05] to-transparent rounded-full blur-[60px] pointer-events-none"></motion.div>
                    ...
                    <div className="flex overflow-x-auto gap-3 pb-4 -mx-5 px-5 snap-x hide-scrollbar relative z-20">
                        {data.tabs.map((tab) => {
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <motion.div animate={{ opacity: [0.3, 0.7, 0.3], scale: [1, 1.05, 1] }} transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }} className="absolute top-0 right-0 w-20 h-20 opacity-20 blur-[20px] rounded-bl-full" style={{ background: tab.color }}></motion.div>
                                    )}
                                    <div 
                                    ...
                                    >
                                        {isActive && <div className="absolute inset-0 bg-white/20 rounded"></div>}

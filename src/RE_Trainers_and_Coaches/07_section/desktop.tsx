...
export default function Desktop() {
    ...
    return (
        <section className="w-full py-32 bg-[#F8FAFD] relative font-['Outfit'] overflow-hidden">
            ...
            <div className="absolute top-[20%] left-[-10%] w-[800px] h-[800px] bg-gradient-radial from-[#C99A2E]/[0.05] to-transparent rounded-full blur-[100px] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] bg-gradient-radial from-[#3B82F6]/[0.04] to-transparent rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <div className="max-w-[1320px] mx-auto px-12 relative z-10">
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start max-w-[1100px] mx-auto">
                        ...
                        {data.tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`relative p-6 rounded-[24px] flex items-center gap-5 text-left transition-all duration-500 w-full overflow-hidden group ${
                                        isActive 
                                ...
                                >
                                    ...
                                    {isActive && (
                                        <div className="absolute top-0 right-0 w-32 h-32 opacity-20 blur-[30px] rounded-bl-full" style={{ background: tab.color }}></div>
                                    )}
                                    <div 
                                        className={`w-14 h-14 rounded-[16px] flex items-center justify-center shrink-0 transition-all duration-500 relative overflow-hidden ${
                    ...
                    {/* Right Content Area */}
                    <div className="flex-1 w-full bg-white border border-[#0B1D3A]/[0.06] rounded-[32px] p-10 lg:p-14 min-h-[550px] flex flex-col relative overflow-hidden shadow-[0_10px_40px_-10px_rgba(11,29,58,0.05)]">
                        <AnimatePresence mode="wait">
                            ...
                            >
                                {/* Decorative elements */}
                                <div className="absolute -top-10 -right-10 w-64 h-64 opacity-10 blur-[60px] pointer-events-none rounded-full" style={{ background: activeTabData.color }}></div>
                                ...
                                <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl mb-8 border backdrop-blur-md" style={{ backgroundColor: `${activeTabData.color}10`, borderColor: `${activeTabData.color}20`, color: activeTabData.color }}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 mt-auto">
                                    {activeTabData.features.map((feature, idx) => (
                                        <motion.div 
                                            ...
                                            className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-[#F8FAFD] transition-colors duration-300 border border-transparent hover:border-[#0B1D3A]/5 cursor-default"
                                        >
                                            <div className="mt-1 shrink-0 p-1.5 rounded-lg transition-colors duration-300 shadow-sm" style={{ backgroundColor: `${activeTabData.color}15`, color: activeTabData.color }}>

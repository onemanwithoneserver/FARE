        ...
        >
            ...
            <div className="w-full px-5 flex flex-col items-center relative z-10">
                ...
                >
                    ...
                    <motion.h1
                        variants={item}
                        className="font-black mb-4 text-[2.25rem] sm:text-[2.5rem] leading-[1.08] tracking-[-0.03em]"
                        style={{ color: NAVY }}
                    >
                        {data.headline}
                    </motion.h1>
                    ...
                    <motion.div variants={item} className="mb-1.5">
                        <h2 className="font-bold text-[16px] leading-snug" style={{ color: NAVY }}>
                            {data.subheadline}
                        </h2>
                    </motion.div>

                    <motion.p variants={item} className="text-[14.5px] font-medium leading-[1.65] mb-8 max-w-[420px] mt-4" style={{ color: '#3A4A63' }}>
                        {data.description}
                    </motion.p>

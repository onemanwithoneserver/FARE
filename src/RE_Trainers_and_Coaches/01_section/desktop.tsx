            ...
            <div className="max-w-[1280px] w-full px-8 lg:px-12 py-16 lg:py-24 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 xl:gap-16 items-center">
                    ...
                    >
                        ...
                        <motion.h1
                            variants={item}
                            className="font-black mb-5 text-[#0B1D3A] text-[2.75rem] xl:text-[3.5rem] leading-[1.1] tracking-[-0.03em]"
                        >
                            {data.headline}
                        </motion.h1>

                        <motion.div variants={item} className="mb-4">
                            <h2 className="font-bold text-[#0B1D3A] text-[19px] xl:text-[21px] leading-snug">
                                {data.subheadline}
                            </h2>
                        </motion.div>

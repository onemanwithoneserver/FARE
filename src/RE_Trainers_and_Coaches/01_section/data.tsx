...
export const dataEn = {
  ...
  footerText:
    "Built specifically for RE Trainers, Coaches and Training Professionals.",
  dashboard: {
    title: "Trainer Hub",
    stats: [
      {
...
export const dataTe = {
  ...
  subheadlineAccent:
    "మీ నైపుణ్యాన్ని మరింత శక్తివంతమైన అభ్యాస అనుభవంగా మార్చండి.",
  description:
    "మీ అభ్యాసకులతో కనెక్ట్ కావడానికి, స్ట్రక్చర్డ్ ప్రోగ్రామ్స్ అందించడానికి, మాక్స్ ద్వారా ప్రాక్టీస్ చేయడానికి మరియు రియల్ ఎస్టేట్ ట్రైనింగ్ కోసం చూస్తున్న సంస్థలను చేరుకోవడానికి FARE ని ఉపయోగించండి.",

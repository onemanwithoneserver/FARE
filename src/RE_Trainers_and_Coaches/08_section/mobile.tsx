        ...
        <section className="w-full py-10 bg-[#040C1E] relative font-['Outfit'] overflow-hidden">
            ...
            <div className="px-5 relative z-10">
                ...
                >
                    ...
                    <motion.h2 variants={item} className="text-[2rem] sm:text-[2.25rem] leading-[1.12] font-black tracking-[-0.02em] mb-1 bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70">
                        {data.headline}
                    </motion.h2>
                ...
                <div className="flex flex-col gap-6 mb-8">
                    ...
                    >
                        ...
                        <ul className="flex flex-col gap-4 relative z-10">
                            {data.youBring.items.map((item, idx) => (
                                <li key={idx} className="flex items-start gap-3 text-[15px] font-medium text-white/70">
                    ...
                    <div className="flex items-center justify-center py-2">
                        <div className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 shadow-inner backdrop-blur-md relative overflow-hidden">
                    ...
                    >
                        ...
                        <ul className="flex flex-col gap-4 relative z-10">
                            {data.fareBrings.items.map((item, idx) => (
                                <li key={idx} className="flex items-start gap-3 text-[15px] font-medium text-white/70 flex-row-reverse text-right">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md mb-8">
                        ...
                        <h3 className="text-[12px] font-bold text-white uppercase tracking-[0.2em] text-center">
                            {data.together.title}
                        </h3>
                    </div>
